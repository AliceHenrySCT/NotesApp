...
- **Uploading Note Files:**  
  ...
  - Details:  
    ...
    - owners: Either a single owner or multiple owner IDs separated by commas.  
    - description: The note description.

(For more details, refer to the script.js file which handles these operations.)
...
├── routes/
│   └── noteRoutes.js        # API endpoints for notes and user actions
├── controllers/
│   └── noteController.js    # Logic for handling API requests
├── config/
│   └── db.js                # MongoDB connection setup
├── middlewares/
│   └── auth.js              # JWT authentication and request logging
├── public/                  # Frontend static files
│   ├── index.html           # Home page
│   ├── login.html           # Login page
│   ├── register.html        # Registration page
│   ├── noteList.html        # Note management page
│   ├── style.css            # CSS styling
│   └── script.js            # Frontend JavaScript functionality
└── .env                     # Environment variable configuration (not tracked by git)

> Note: The Mongoose models for User and Note should be located under a /models directory. Ensure these are created as per your application's requirements.

## Contributing

Contributions are welcome! If you wish to improve the project or fix bugs, please follow these guidelines:

1. Fork the repository.
2. Create a new branch for your feature or bug fix.
3. Write tests and ensure code quality.
4. Submit a pull request with a clear description of your changes.
5. Ensure that your code adheres to the existing style guidelines.
